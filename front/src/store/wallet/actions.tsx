import { CREATE_ACCOUNT_FAILURE, CREATE_ACCOUNT_REQUEST, CREATE_ACCOUNT_SUCCESS, CREATE_WALLET_FAILURE, CREATE_WALLET_REQUEST, CREATE_WALLET_SUCCESS, GET_WALLET_FAILURE, GET_WALLET_REQUEST, GET_WALLET_SUCCESS } from "./types"
...
export const requestGetWallet = (action: WalletAction) => ({ type: GET_WALLET_REQUEST})
export const successGetWallet = (action: WalletAction) => ({ type: GET_WALLET_SUCCESS, payload: action.payload})
export const failureGetWallet = (action: WalletAction) => ({ type: GET_WALLET_FAILURE, payload: action.payload})